namespace OpenCvSharp.Demo
{
        ...
        where T: UnityEngine.Texture
    {
        ...
        protected virtual Mat MatFromTexture(UnityEngine.Texture2D texture, Unity.TextureConversionParams texParams)
        {
        ...
        /// <param name="texParams">Texture parameters (flipped, rotated etc.)</param>
        protected virtual void ImportTexture(UnityEngine.Texture2D texture, Unity.TextureConversionParams texParams)
        {
        ...
        public virtual void ProcessTexture(UnityEngine.Texture2D texture, Unity.TextureConversionParams texParams, bool detect = true)
        {
        ...
        where T : UnityEngine.Texture
    {
        ...
        /// <param name="texParams">Texture parameters (flipped, rotated etc.)</param>
        /// <param name="detect">Flag signalling whether we need detection on this frame</param>
        public override void ProcessTexture(UnityEngine.Texture2D texture, Unity.TextureConversionParams texParams,  bool detect = true)
        {
